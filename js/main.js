const AUDIO = [new Audio('https://www.dropbox.com/s/913tcne4bo54dj0/Blop-Mark_DiAngelo-79054334.mp3?raw=1')];
var STOP = 0,
  START = 1,
  BREAK = 2,
  PAUSE = 3,
...
var vm = new Vue({
  ...
  methods: {
    ...
    toggleTasksView: function () {

      if(this.taskViewIsActive){
        this.taskViewIsActive = false;
        document.getElementById('clock-view').style.width = '100vw';
        document.getElementById('tasks-view').style.width = '0%';
      }else{
        this.taskViewIsActive = true;
        document.getElementById('clock-view').style.width = '50vw';
        document.getElementById('tasks-view').style.width = '50vw';
      }
    },
    addNewTask: function (){
      this.tasks.push(
